...
jest.mock('../src/ShareButton');
jest.mock('../src/UserManual');
...
describe("Routing", () => {
  ...
  it("renders UserManual for usermanual route", () => {
    (UserManual as jest.Mock).mockImplementation(() => <div>UserManualMock</div>);
    
    render(<MemoryRouter initialEntries={["/usermanual"]}><App /></MemoryRouter>);
    expect(screen.getByText("UserManualMock")).toBeTruthy();
  })
});